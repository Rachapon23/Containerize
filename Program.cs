...
namespace DQiTs1
{
    class Program
    {
        static void Main()
        {
            ...
            var userID = CHCNetSDK.NET_DVR_Login_V30("192.168.1.108", (short)8000, "admin", "DIATIoT01", ref deviceInfo);
            if (userID < 0)
            {
            ...
            else
            {
                ...
                CHCNetSDK.NET_DVR_SaveRealData(realHandle, "/source/video/Record_test0.mp4");
                Thread.Sleep(1000);
